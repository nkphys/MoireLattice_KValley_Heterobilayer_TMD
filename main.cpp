...
//Path-2
	...
	n2--;
        ...
        //K'' to K=(n1=L1/3, n2=2L2/3);
	n1=-2*int(L1_/3)+1 ;
        n2=-int(L2_/3)+1;
        while(n2<=2*int(L2_/3)){
        temp_pair.first = n1;
        temp_pair.second = n2;
        k_path2.push_back(temp_pair);
        n1++;
	...
	//-----------------------------
        ...
        for(int index=0;index<k_path2.size();index++){
        n1=k_path2[index].first;
        n2=k_path2[index].second;
	cout<<n1<<"  "<<n2<<endl;
