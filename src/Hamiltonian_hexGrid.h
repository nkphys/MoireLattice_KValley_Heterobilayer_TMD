...
//---------------
   ...
   //------------------------------------------
    ...
    FileWNROut<<"#index r1 r2 W_r  ....."<<endl;
    for(int r1_ind=0;r1_ind<space_slices;r1_ind++){
        for(int r2_ind=0;r2_ind<space_slices;r2_ind++){
            r_ind=r1_ind + (space_slices)*r2_ind;
	    dis_x = ((r1_min + r1_ind*d_r1)*(sqrt(3.0)/2.0)) + ((r2_min + r2_ind*d_r2)*(sqrt(3.0)/2.0));
            dis_y = ((r1_min + r1_ind*d_r1)*((-1.0)/2.0)) + ((r2_min + r2_ind*d_r2)*((1.0)/2.0));
            FileWNROut<<r_ind<<"  "<<(r1_min + r1_ind*d_r1)/(Parameters_.a_moire)<<"   "<<(r2_min + r2_ind*d_r2)/(Parameters_.a_moire)<<"   "<<dis_x/(Parameters_.a_moire)<<"   "<<dis_y/(Parameters_.a_moire)<<"   "<<Wnr_state_[r_ind].real()<<"   "<<Wnr_state_[r_ind].imag() <<endl;
            checknorm += (sqrt(3.0)/2.0)*d_r1*d_r2*Wnr_state_[r_ind]*conj(Wnr_state_[r_ind]);
        }
        FileWNROut<<endl;
    }
...
//( kx_*((1.0/(2.0*sqrt(3.0)))*Parameters_.a_moire) + ky_*( (0.5)*Parameters_.a_moire)
	...
	if( ( r1_min + r1_ind*d_r1 - (dis_1*0.5))>(r1_min-d_r1*0.1)  &&  ( r1_min + r1_ind*d_r1 - (dis_1*0.5)) < (r1_max+d_r1*0.1) &&
	    ( r1_min + r1_ind*d_r1 + (dis_1*0.5))>(r1_min-d_r1*0.1)  &&  ( r1_min + r1_ind*d_r1 + (dis_1*0.5)) < (r1_max+d_r1*0.1) &&
	    ( r2_min + r2_ind*d_r2 - (dis_2*0.5))>(r2_min-d_r2*0.1)  &&  ( r2_min + r2_ind*d_r2 - (dis_2*0.5)) < (r2_max+d_r2*0.1) &&
 	   ( r2_min + r2_ind*d_r2 + (dis_2*0.5))>(r2_min-d_r2*0.1)  &&  ( r2_min + r2_ind*d_r2 + (dis_2*0.5)) < (r2_max+d_r2*0.1)
    ) {
	int r1_ind_l = int((r1_ind*d_r1 - (dis_1*0.5) + d_r1*0.01)/(d_r1));
	int r2_ind_l = int((r2_ind*d_r2 - (dis_2*0.5) + d_r2*0.01)/(d_r2));
	int r1_ind_r = int((r1_ind*d_r1 + (dis_1*0.5) + d_r1*0.01)/(d_r1));
        int r2_ind_r = int((r2_ind*d_r2 + (dis_2*0.5) + d_r2*0.01)/(d_r2));
...
//	int ry_ind_r = ry_ind;	
     ...
     int r_ind_l=r1_ind_l + (space_slices)*r2_ind_l;
